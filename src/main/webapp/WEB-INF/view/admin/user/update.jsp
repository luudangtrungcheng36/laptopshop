                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12 mx-auto">
                                        ...
                                        <form:form method="post" enctype="multipart/form-data"
                                            action="/admin/user/update" modelAttribute="newUser">
                                            ...
                                            <div class="mb-3 col-12 col-md-6">
                                                <label for="avatarFile" class="form-label">Avatar: <img
                                                        src="${pageContext.request.contextPath}/images/avatars/${newUser.avatar}"
                                                        alt="avatar"
                                                        style="width:120px;height:120px;object-fit:cover;border-radius:50%;" /></label>
